...
# Game over Image
gmimg = pygame.image.load("background.jpg")
gmimg = pygame.transform.scale(gmimg, (screen_width, screen_height)).convert_alpha()

# Game Title
pygame.display.set_caption("Snake Game made by 'Irfan' for 'Farisha'")
...
def gameloop():
    ...
    while not exit_game:
        if game_over:
            ...
            # gameWindow.fill(fav2)
            # text_screen("You are Doomed!!! Press Enter to Continue", red, 100, 250)
